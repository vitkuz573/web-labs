...
<div class="p-4">
  <div class="rounded-lg shadow-lg bg-white max-w-sm">
    <a href="#">
      <img class="rounded-t-lg" src="assets/images/<?php echo $item['image']; ?>" alt="<?php echo $item['name']; ?>"/>
    </a>
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2"><?php echo $item['name']; ?></h5>
      <p class="text-gray-700 text-base mb-4"><?php echo $item['description']; ?></p>
      <p class="text-gray-700 text-base mb-4"><?php echo $item['cost']; ?> ₽</p>
      <button type="button" onclick="addToCart(<?php echo $item['id']; ?>);" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Добавить в корзину</button>
    </div>
  </div>
</div>
<?php
